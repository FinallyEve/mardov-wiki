...
type: character
role: npc-major
name: "Kiera Duskhallow"
aliases: ["Tesca's Mother"]
race: "Tiefling"
class: "N/A"
affiliation: "Dusker's Initiative (former)"
location: "Deceased"
status: dead
first_appearance: "Referenced in [[Tesca]]'s backstory"
source: ["Tesca's Backstory", "NPC Catalog"]
art: ["assets/npc-art-source/Met/Kiera Duskhallow"]
---
...
Kiera's death connects [[Tesca]]'s personal tragedy to the campaign's central plot -- the [[Diadem of Dawn]] is actually the [[Anchor of Famine]], and the artifact that got her parents killed is the one Tesca must wield to save the world.
